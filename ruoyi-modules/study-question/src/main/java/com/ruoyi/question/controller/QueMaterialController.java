...
public class QueMaterialController  extends BaseController
{
    ...
    public TableDataInfo list(QueMaterial queMaterial)
    {
        ...
        //查询条件
        wrapper2.lambda().like(StringUtils.isNotEmpty(queMaterial.getMaterialName()), QueMaterial::getMaterialName,queMaterial.getMaterialName())
            .eq(StringUtils.isNotEmpty(queMaterial.getMaterialType()),QueMaterial::getMaterialType,queMaterial.getMaterialType())
            .eq(ObjectUtils.isNotEmpty(queMaterial.getSubjectId()),QueMaterial::getSubjectId,queMaterial.getSubjectId());
