<template>
  <div>
    <div @click="editCropper()" class="user-info-head"><img class="img-circle img-lg" title="点击上传头像"
                                                            v-bind:src="options.img"/></div>
    <el-dialog :title="title" :visible.sync="open" @close="closeDialog()" @opened="modalOpened"
