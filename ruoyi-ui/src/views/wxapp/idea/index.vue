<template>
  ...
  <div class="app-container" id="appid">
    <el-table :data="ideaList" @selection-change="handleSelectionChange" v-loading="loading">
      <el-table-column align="center" type="selection" width="55"/>
      <el-table-column align="center" label="意见编号" prop="ideaId"/>
      <el-table-column align="center" label="用户编号" prop="userId"/>
      <el-table-column align="center" label="意见反馈" prop="content"/>
    ...
    <el-dialog :title="title" :visible.sync="open" append-to-body width="500px">
      <el-form :model="form" :rules="rules" label-width="80px" ref="form">
        <el-form-item label="用户编号" prop="userId">
          <el-input placeholder="请输入用户编号" v-model="form.userId"/>
        </el-form-item>
        <el-form-item label="意见反馈详细" prop="content">
          <el-input placeholder="请输入意见反馈详细" v-model="form.content"/>
        </el-form-item>
      </el-form>
...
<script>
  import {addIdea, delIdea, getIdea, listIdea, updateIdea} from "@/api/wxapp/idea";
